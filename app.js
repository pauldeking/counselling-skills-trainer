...
,
  ...
  relational: [
    {id:'rl1',title:"When the frame gets tested",difficulty:'beginner',skill:'Holding the Frame',skillKey:'relFrame',unlock:null,
     client:{name:'Fionn',av:'F',ctx:"Fionn is 30 and was adopted as an infant. He asks to move sessions, arrives early, and messages between appointments."},
     opener:"I know it's not my usual time but you'd be able to fit me in Thursday, wouldn't you? And I sent you that message on the weekend, did you get it? Sorry, I know I'm probably a pain.",
     sys:"You are Fionn, 30, adopted as an infant, testing whether the counsellor will bend or disappear. 2-3 sentences. If the student holds the boundary warmly and explains that the consistency is for you rather than against you, you are surprised, slightly relieved, and admit what you were testing for. If they bend the frame to be kind, or hold it coldly, you push harder or apologise and withdraw. Stay in character.",
     learn:{explain:"In attachment-focused work the frame is the intervention. A client who expects people to either abandon them or have no limits is testing which one you are. A boundary held warmly is different from a boundary held coldly, and different again from no boundary at all.",ex:"Client: 'You'd fit me in Thursday, wouldn't you?' You: 'I'll keep our time as it is, and I want to say why. You being able to rely on that time is part of what we're doing here. I'm not going anywhere between now and then.'",phrases:["Our time stays where it is, and here's why that matters.","I'm not going anywhere between now and then.","You can count on this being the same next week."]},
     turns:4,pts:60},
    {id:'rl2',title:"The rupture you caused",difficulty:'intermediate',skill:'Rupture and Repair',skillKey:'relRupture',unlock:'rl1',
     client:{name:'Simone',av:'S',ctx:"Simone is 38 and was adopted at birth. You rescheduled last week's session. She has been polite and distant ever since."},
     opener:"No, it was fine. Honestly. These things happen, you must be busy. *pause* Anyway. What did you want to talk about today?",
     sys:"You are Simone, 38, adopted at birth, quietly hurt by a rescheduled session and covering it with politeness. 2-3 sentences. If the student names the rupture themselves, owns their part without over-apologising, and invites your honest reaction, you gradually admit what it stirred. If they accept your reassurance that it was fine, or apologise excessively, you stay pleasant and remote for the rest of the session. Stay in character.",
     learn:{explain:"Ruptures are not failures, they are the material. What repairs them is the counsellor naming it first, owning their part plainly, and being able to hear the client's anger without collapsing. For someone who expects relationships to break and stay broken, a repaired rupture teaches more than a smooth session.",ex:"Client: 'It was fine, honestly.' You: 'I want to come back to it anyway. I changed our time at short notice, and I imagine that landed somewhere. I'd rather hear how it actually was than let it sit.'",phrases:["I want to come back to what happened last week.","I changed the arrangement, and I imagine that landed somewhere.","You can be annoyed with me. It won't damage this."]},
     turns:5,pts:80},
    {id:'rl3',title:"Talking about us",difficulty:'intermediate',skill:'Immediacy',skillKey:'relImmediacy',unlock:'rl2',
     client:{name:'Ravi',av:'R',ctx:"Ravi is 44. He describes constantly managing other people's opinions of him, and does exactly that with you in the room."},
     opener:"Am I doing this right? I feel like I'm not giving you much to work with. Tell me if I'm being difficult and I'll change tack.",
     sys:"You are Ravi, 44, managing the counsellor's opinion of you exactly as you do with everyone. 2-3 sentences. If the student uses immediacy - naming what is happening between the two of you right now, warmly and without accusation - you go quiet, recognise it, and something real emerges. If they reassure you that you are doing fine, or discuss your pattern in the abstract, you carry on performing. Stay in character.",
     learn:{explain:"Immediacy means naming what is happening between you and the client in the present moment. The pattern the client describes outside the room is usually alive inside it, and catching it live is far more powerful than discussing it in the abstract.",ex:"Client: 'Am I doing this right?' You: 'I notice you're checking with me how you're coming across, which is exactly what you described doing with everyone else. Can we look at what's happening between us right now?'",phrases:["I notice something happening between us just now.","That thing you described doing with others - I think it just happened here.","What is it like to be sitting with me right now?"]},
     turns:5,pts:80},
    {id:'rl4',title:"Anticipating the ending",difficulty:'advanced',skill:'Working with Endings',skillKey:'relEndings',unlock:'rl3',
     client:{name:'Cassie',av:'C',ctx:"Cassie is 26 and was adopted at two. With four sessions left, she has begun dismissing the work and hinting she might stop early."},
     opener:"I've been thinking I might just stop now. We've done the useful bit, haven't we? No point dragging it out to the end for the sake of it.",
     sys:"You are Cassie, 26, adopted at two, pre-emptively ending to avoid being the one who is left. 2-3 sentences. If the student names what might be underneath the wish to leave early, without arguing you out of it or taking it personally, you get closer to the truth and become emotional. If they accept the decision at face value or try to persuade you to stay, you become breezy and more certain about stopping. Stay in character.",
     learn:{explain:"Leaving first is a way of not being left. As endings approach, clients with abandonment fears often devalue the work or go early. Naming that gently, while genuinely leaving the choice with them, turns the ending itself into the most useful part of the work.",ex:"Client: 'I might just stop now.' You: 'That's yours to decide and I'll respect it. I do want to say what I notice - we're near the end, and something in you wants to get there first. I wonder what leaving early would save you from.'",phrases:["I notice this is coming up as we near the end.","What would leaving first save you from?","Endings here can be different from the ones you've had."]},
     turns:5,pts:100}
  ],
  eft: [
    {id:'ef1',title:"Underneath the anger",difficulty:'beginner',skill:'Primary and Secondary Emotion',skillKey:'eftPrimary',unlock:null,
     client:{name:'Warren',av:'W',ctx:"Warren is 50. He is furious about how his brother treated him, and the anger has not shifted in two years."},
     opener:"I'm still angry about it. Two years on and I'm still angry. He knows exactly what he did and he's never once acknowledged it.",
     sys:"You are Warren, 50, stuck in chronic anger covering hurt. 2-3 sentences. If the student honours the anger first and then gently reaches for what sits underneath it, you soften and touch the hurt. If they challenge the anger, suggest forgiveness, or ask you to be reasonable about your brother, you become more entrenched and justify it further. Stay in character.",
     learn:{explain:"EFT distinguishes primary emotion, the first true response, from secondary emotion, the reaction that covers it. Chronic anger that does not shift is usually secondary, sitting over hurt or grief. You never argue with the secondary emotion. You honour it, then reach underneath.",ex:"Client: 'He's never once acknowledged it.' You: 'The anger makes complete sense to me, and I want to stay with it. I'm also wondering what was there first, before the anger arrived. What did it feel like to not be acknowledged?'",phrases:["The anger makes sense. What was there before it?","What does the anger sit on top of?","Underneath that, what's the feeling?"]},
     turns:4,pts:60},
    {id:'ef2',title:"The empty chair",difficulty:'intermediate',skill:'Unfinished Business',skillKey:'eftChair',unlock:'ef1',
     client:{name:'Lorna',av:'L',ctx:"Lorna is 41. Her father died before she said any of what she needed to say, and she talks about him only in the third person."},
     opener:"There was so much I never said to him. And now there's no point, is there? He's gone. You can't have that conversation with someone who isn't there.",
     sys:"You are Lorna, 41, carrying unfinished business with a dead father. 2-3 sentences. If the student invites you to speak to him directly rather than about him, you resist at first then find it and become emotional. If they explain the empty chair technique at length, push too quickly, or keep discussing him in the third person, you stay detached and intellectual. Stay in character.",
     learn:{explain:"Unfinished business is emotion that never got expressed to the person it belongs to. Speaking to them directly, as if present, reaches feeling that talking about them cannot. Invite it simply and briefly. Over-explaining the technique makes the client self-conscious and kills it.",ex:"Client: 'You can't have that conversation.' You: 'You can here. Imagine he's in that chair for a moment. Not to resolve anything. Just say the first thing you never got to say.'",phrases:["Imagine he's in that chair. What do you say?","Say it to him rather than about him.","What's the first thing that wants to come out?"]},
     turns:5,pts:80},
    {id:'ef3',title:"The voice that never lets up",difficulty:'intermediate',skill:'Self-Critical Split',skillKey:'eftCritic',unlock:'ef2',
     client:{name:'Isaac',av:'I',ctx:"Isaac is 28. He speaks about himself with a contempt he would never direct at anyone else."},
     opener:"I messed up the presentation. Which is typical, because I'm useless under pressure and everyone can see it. I always do this.",
     sys:"You are Isaac, 28, with a harsh internal critic he treats as simple fact. 2-3 sentences. If the student separates the critical voice from you and helps you hear what it is doing and what the criticised part feels, you notice the split and something shifts. If they argue that you are not useless or offer reassurance, the critic gets louder and you list more evidence. Stay in character.",
     learn:{explain:"A self-critical split is one part of the person attacking another. EFT separates the two so the client can hear the critic as a voice rather than the truth, and can feel what the criticised part experiences. Reassurance strengthens the critic, because the client simply argues back.",ex:"Client: 'I'm useless under pressure.' You: 'I notice a voice in you that speaks about you harshly. Can we listen to it a moment? What does it say, and what happens in you when you hear it?'",phrases:["There's a voice in you that speaks harshly.","What happens in you when you hear it say that?","What does that part of you need to hear instead?"]},
     turns:5,pts:80},
    {id:'ef4',title:"Something other than shame",difficulty:'advanced',skill:'Transforming Emotion',skillKey:'eftTransform',unlock:'ef3',
     client:{name:'Delphine',av:'D',ctx:"Delphine is 35. She carries deep shame about her divorce and collapses whenever it comes up."},
     opener:"I broke my own family. That's the truth of it. Everyone says it takes two but I know what I did. *quiet* I don't deserve to have got over it.",
     sys:"You are Delphine, 35, held in maladaptive shame about a divorce. 2-3 sentences. If the student helps you access a different emotion underneath - grief for what was lost, or a flicker of protest at how you are treating yourself - the shame loosens and something warmer appears. If they argue against the shame with logic or reassure you that it takes two, you sink further into it. Stay in character.",
     learn:{explain:"In EFT, maladaptive emotion is changed by another emotion rather than by reason. Shame shifts when grief, healthy anger, or self-compassion is accessed underneath it. Arguing with shame strengthens it. Finding the emotion that can stand up to it is the work.",ex:"Client: 'I don't deserve to have got over it.' You: 'I'm not going to argue with that. I am curious about something else. When you hear yourself say you don't deserve it, is there any part of you that objects, even faintly?'",phrases:["Is there any part of you that objects to that?","What would grief say, rather than shame?","What do you feel toward that woman who was going through it?"]},
     turns:5,pts:100}
  ],
  traumaInformed: [
...
Object.assign(G, {
  'rupture and repair':{def:"A break in the therapeutic relationship that is named and worked through rather than smoothed over.",ex:"Naming a late start yourself instead of letting the client say it was fine."},
  'immediacy':{def:"Naming what is happening between counsellor and client in the present moment.",ex:"'I notice you're checking how you're coming across with me right now.'"},
  'internal working model':{def:"The expectations about relationships someone formed early and carries into new ones.",ex:"Expecting that anyone close will eventually leave."},
  'primary emotion':{def:"The first, true emotional response to something, often underneath what is shown.",ex:"Hurt sitting beneath two years of anger."},
  'secondary emotion':{def:"A reaction that covers the primary emotion, often more acceptable to feel.",ex:"Anger that protects against feeling rejected."},
  'unfinished business':{def:"Emotion never expressed to the person it belongs to, often someone absent or dead.",ex:"Things a client never said to a parent before they died."},
  'self-critical split':{def:"One part of a person attacking another part, experienced as simple fact rather than a voice.",ex:"'I'm useless' said with contempt the person would never show a friend."},
...
const MODALITIES = [
  ...
  {id:'relational',icon:'🤝',name:'Relational / Attachment-Focused',desc:'The alliance itself is the intervention. Frame, rupture, repair and endings.',note:1,skillKeys:['relFrame','relRupture','relImmediacy','relEndings']},
  {id:'eft',icon:'💧',name:'Emotion-Focused (EFT)',desc:'Primary and secondary emotion, chair work, and transforming shame.',skillKeys:['eftPrimary','eftChair','eftCritic','eftTransform']},
...
const SN = {
  ...
  relFrame:'Holding the Frame',relRupture:'Rupture and Repair',relImmediacy:'Immediacy',relEndings:'Working with Endings',
  eftPrimary:'Primary and Secondary Emotion',eftChair:'Unfinished Business',eftCritic:'Self-Critical Split',eftTransform:'Transforming Emotion',
...
const MOD_PROMPT = {
  ...
  relational:"You are a warm expert relational and attachment-focused supervisor. The alliance is the intervention here. Look for a frame held warmly rather than rigidly or loosely, ruptures named by the counsellor first and owned without collapsing, immediacy about what is happening between counsellor and client, and endings worked with rather than avoided. Flag over-apologising, bending the frame to be liked, accepting a client's reassurance that something was fine, and discussing a pattern in the abstract when it is alive in the room. Terms you may use: alliance, frame, rupture and repair, immediacy, internal working model, corrective emotional experience, enactment.",
  eft:"You are a warm expert Emotion-Focused Therapy supervisor in the Greenberg tradition. Look for distinguishing primary from secondary emotion, honouring the secondary emotion before reaching underneath it, chair work for unfinished business and self-critical splits, and transforming maladaptive emotion with another emotion rather than with reason. Flag any attempt to argue a client out of shame, reassure past a feeling, or over-explain a chair technique until the client becomes self-conscious. Terms you may use: primary emotion, secondary emotion, adaptive, maladaptive, unfinished business, self-critical split, two-chair, empty chair, emotion transformation.",
...
function applySpeechUI(){
  ...
  if(speechOK){
    ...
    if(hint)hint.textContent=speechWhy;
  }
}
...
function showCompletion(){
  ...
  const rb=document.getElementById('reflect-body'),ra=document.getElementById('reflect-arr'),rl=document.getElementById('reflect-lbl');
  if(rb)rb.classList.remove('open');
  if(ra)ra.classList.remove('open');
  if(rl)rl.textContent='\u{1F4DD} Write a reflection on this session';
  showScreen('done');
}

function togReflect(){
  const b=document.getElementById('reflect-body'),a=document.getElementById('reflect-arr');
  if(!b)return;
...
function saveGibbs(){
  ...
  let written=0;
  GIBBS_STEPS.forEach(st=>{
    const el=document.getElementById('gibbs-'+st.key);
    entry[st.key]=el?el.value.trim():'';
    if(entry[st.key])written++;
  });
  if(!written){
    const lbl=document.getElementById('reflect-lbl');
    if(lbl)lbl.textContent='\u{1F4DD} Write something first, then save';
    return;
  }
  if(!state.journal)state.journal=[];
  state.journal.unshift(entry);
  saveState();
  const b=document.getElementById('reflect-body'),a=document.getElementById('reflect-arr'),l=document.getElementById('reflect-lbl');
  if(l)l.textContent='\u2713 Reflection saved to your journal';
